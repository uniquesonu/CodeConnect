  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
      ...
      >
        ...
        <div className="mt-8">
          <h1 className="text-3xl font-bold text-center text-white mb-2">Welcome to ShareScribe</h1>
          <p className="text-gray-200 text-center mb-8">Create your account and start sharing</p>
        </div>
